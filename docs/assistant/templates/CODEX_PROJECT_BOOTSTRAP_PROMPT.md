...
- `BOOTSTRAP_ROADMAP_GOVERNANCE.md`: adaptive roadmap triggering, fresh-session resume, active-worktree authority, and detour/closeout governance.
...
When roadmap governance is activated, generate docs/assistant/workflows/ROADMAP_WORKFLOW.md, docs/assistant/SESSION_RESUME.md, an active roadmap tracker, and an active wave ExecPlan, and make the active worktree authoritative during live wave work.
