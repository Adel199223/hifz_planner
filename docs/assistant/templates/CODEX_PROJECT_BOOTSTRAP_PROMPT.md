...
When roadmap governance is activated, generate docs/assistant/workflows/ROADMAP_WORKFLOW.md, docs/assistant/SESSION_RESUME.md as the roadmap anchor file, an active roadmap tracker, and an active wave ExecPlan, make the active worktree authoritative during live wave work, and archive completed roadmap trackers/finished ExecPlans to docs/assistant/exec_plans/completed/ when no roadmap is active.
